...
8. Prefer the **native managers** over toolkit wrappers wherever a native one exists (§1.2, §4.3). Keep the toolkit for `DialogHelper`, `VirtualizedTableHelper`, `FilePickerHelper`, `ClipboardHelper`, `KeyboardManager`, and `unregisterAll()`.
