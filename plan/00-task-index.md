...
> **Last updated:** 2026-09-10 · **103 tasks: 9 `DONE`, 94 `TODO`.**

---

## 1. Status

Implementation has started. Nine tasks are `DONE` as of 2026-09-10 — `P0-T01`,
`P0-T29`, `P0-T02`, `P0-T03`, `P0-T04`, `P0-T05`, `P0-T06`, `P0-T07` and
`P0-T30` (commits `df15816`, `010ede3`, `437b366`, `500cf7b`, `82926d3`,
`0675412`); every other task is `TODO`. Only a human sets a task to `DONE`
